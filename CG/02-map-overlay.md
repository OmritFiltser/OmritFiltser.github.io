...
האלגוריתם **FindIntersections**, מבני הנתונים להם נזדקק עבור תור
...
לעצור מייד עם מציאת נקודת החיתוך הראשונה. נקבל זמן ריצה של $O(n\log n)$.

</details>
:::

### כיצד נבדוק האם זוג קטעים נחתכים? {#check-line-int}
...
3.  נבדוק האם $t$ שייכת לשני הקטעים $S$ ו-$S'$.
...
הצירים, אך פעולה זו לא תמיד אפשרית. אפשרות אחרת היא להשתמש ב**הנחת מצב
