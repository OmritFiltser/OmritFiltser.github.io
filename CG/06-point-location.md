...
נוסף על כך, לגרף יש שורש יחיד ובדיוק עלה אחד לכל טרפז במפה $\mathcal{D}$. באיור למשל, לעלה של טרפז C יש מצביעים משני קודקודים פנימיים.
...
כשנגיע לעלה, נבדוק אם הטרפז המתאים לו מכיל אתq.
...
תהי $q$ נקודת שאילתה. נרצה להעריך את תוחלת אורך המסלול כאשר נחפש במבנה $\mathcal{D}$ את הטרפז שמכיל את $q$ (מספר הצמתים מהשורש לטרפז). לשם כך, ננסה להבין כיצד המסלול משתנה במהלך ריצת אלגוריתם הבנייה של $\mathcal{D}$.
